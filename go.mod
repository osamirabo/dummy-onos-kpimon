module github.com/osamirabo/dummy-onos-kpimon

go 1.20

require (
	github.com/google/uuid v1.3.0
	github.com/onosproject/onos-lib-go v0.10.14
)
...
require (
	...
	github.com/onosproject/onos-e2-sm/servicemodels/e2sm_kpm_v2_go v0.8.36 // indirect
