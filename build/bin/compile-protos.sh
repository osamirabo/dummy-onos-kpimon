...
proto_imports=".:${GOPATH}/src/github.com/gogo/protobuf/protobuf:${GOPATH}/src/github.com/gogo/protobuf:${GOPATH}/src/github.com/envoyproxy/protoc-gen-validate:${GOPATH}/src":"${GOPATH}/src/github.com/osamirabo/dummy-onos-kpimon/api"
...
cp -r github.com/osamirabo/dummy-onos-kpimon/* .
rm -rf github.com
